...
class ExperimentDashboard(QMainWindow):
    ...
    def _init_ui(self):
        ...
        self.launch_race_button.setToolTip("Launch a new race to compare a challenger model against baselines.")
        ...
        self.archive_button.setToolTip("Open the archive to view or restore archived experiments.")
        self.archive_button.clicked.connect(self.open_archive_browser)
        self.refresh_button = QPushButton(" Refresh")
        self.refresh_button.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_BrowserReload))
        self.refresh_button.setToolTip("Manually refresh the list of experiments (also refreshes automatically).")
        ...
        self.name_filter_input.setToolTip("Filter experiments by name (case-insensitive).")
        ...
        self.status_filter_combo.setToolTip("Filter experiments by their current status.")
        ...
        self.dataset_filter_combo.setToolTip("Filter experiments by the dataset they were run on.")
